...
class DefaultRealmModuleMediator extends RealmProxyMediator {
    ...
    public <E extends RealmModel> E copyOrUpdate(Realm realm, E obj, boolean update, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (clazz.equals(com.example.takeorder.realm.RealmStaff.class)) {
            ...
            return clazz.cast(io.realm.com_example_takeorder_realm_RealmStaffRealmProxy.copyOrUpdate(realm, columnInfo, (com.example.takeorder.realm.RealmStaff) obj, update, cache, flags));
        }
        if (clazz.equals(com.example.takeorder.realm.RealmOrders.class)) {
        ...
        if (clazz.equals(com.example.takeorder.realm.RealmMenuItemsOrders.class)) {
            ...
            return clazz.cast(io.realm.com_example_takeorder_realm_RealmMenuItemsOrdersRealmProxy.copyOrUpdate(realm, columnInfo, (com.example.takeorder.realm.RealmMenuItemsOrders) obj, update, cache, flags));
        }
        throw getMissingProxyClassException(clazz);
    }
